...
const HomePage = () => {
    ...
    const handleSearch = async () => {
        try {
            ...
            const response = await axios.get<Course[]>('https://nextjs-fastapi-backend-ten.vercel.app/api/courses', { params: { query: filteredQuery, hub_units: hubUnits, codes, search_mode: searchMode } });
